...
dotnet run --project src/EraKGLoader/EraKGLoader.fsproj --  --Tunnel ${RINF_DATA_DIR}/ $1 > ${RINF_DATA_DIR}/Tunnels.json
...
dotnet run --project src/EraKGLoader/EraKGLoader.fsproj --  --TunnelInfo.Build ${RINF_DATA_DIR}/ > ${RINF_DATA_DIR}/TunnelInfos.json
